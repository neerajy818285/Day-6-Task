...
const movieDetails = new movie("Dhoom","YRF", "PG-14");
...
const movie1 = new movies("DHOOM","YRF");
console.log(movie1);
...
const movie2 = new movies("DHOOM","YRF","PG-14");
console.log(movie2);
...
class Moviez {
    ...
    let person1 = new Person("neeraj", "yadav",24, "computer", "neerajyadav@gmail.com", 8182853881, "lucknow");
    let person2 = new Person("vashi","muni", 27, "computer science", "vashimuni@gmail.com", 9988771122, "lucknow");
